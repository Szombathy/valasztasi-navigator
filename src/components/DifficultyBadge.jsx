const LEVELS = {
  ...
  'közepes': { label: 'Közepes', className: 'bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400' },
  'részletes': { label: 'Részletes', className: 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400' },
